...
HD_PWD='C:/Users/Tmicro 2/Desktop/JcTFG/ZynqEthernetCamera_2016/ZynqEthernetCamera_2016.runs/Ethernet_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ethernet_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ethernet_xbar_1.tcl
